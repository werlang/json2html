...
window.loadJSONTheme = themes => {
    ...
    themes.forEach(async t => {
        ...
        theme.textContent = await (await fetch(`https://raw.githubusercontent.com/werlang/json2html/main/src/themes/${t}.min.css`)).text();
...
(async () => {
    ...
    style.textContent = await (await fetch('https://raw.githubusercontent.com/werlang/json2html/main/src/json2html.css')).text();
